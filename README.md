...
* ***Add Dependencies***
* ***BDD Framework***
* ***Create Cucumber JUnit TestRunner class***
* ***Create "ContantUtils" class to add all constants***
* ***Create Webconnector class to initialise the WebDriver***
* ***Create CucumberHooks class***
* ***Create manual BDD scenarios for Login feature for "standard_user" username***
* ***Automate the BDD scenarios for the Login page for "standard_user" username***
...
## Add Dependencies in pom.xml file in your project [https://mvnrepository.com/ ]
...
## Create Cucumber JUnit TestRunner class to run the BDD tests
